...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2021/08/19 14:36:06 by rsarri-c          #+#    #+#              #
#    Updated: 2021/08/19 14:36:07 by rsarri-c         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
OBJS	= $(SRCS:.c=.o)
BONUS_S	= ft_lstnew_bonus.c ft_lstadd_front_bonus.c ft_lstadd_back_bonus.c \
